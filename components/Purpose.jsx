      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-2xl md:text-3xl font-black text-slate-900 uppercase tracking-tighter leading-tight">
            Driven by <span className="text-orange-500 text-4xl italic">Trust</span>. Powered by <span className="text-orange-500 text-4xl italic">Technology</span>. Delivered with <span className="text-orange-500 text-4xl italic">Excellence</span>.
          </p>
        </motion.div>
      </div>
    </section>
